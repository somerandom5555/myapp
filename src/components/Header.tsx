...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 border-b border-neutral-900 bg-[#0b0b0e]/60 backdrop-blur dark:border-neutral-700 dark:bg-gray-900/60 transition-colors duration-300">
